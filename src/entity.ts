...
const createEntity = <S extends Schema>(table: Table<S>): Entity<S> => {
    ...
    return {
        ...
        join: (mainAlias, joinType, joinTable, joinAlias, on) =>
...
type NullableAndDefaultColumns<
    S extends Record<string, { default: boolean; nullable: boolean }>
> = keyof {
