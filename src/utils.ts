...
function col<T extends Table, C extends keyof T['columns'] & string>(
    table: T,
    column: C,
    full?: boolean,
    alias?: string
): ValueExpression<ColumnTypeByTable<T, C>>;
function col(table: any, column: any, full: boolean = false, alias?: any): any {
    return ['col', resolveColumn(table, column, full, alias)];
}

function fun<T extends ExpressionTypes>(
    name: string | undefined,
    args: readonly Expression<any>[] | undefined,
    cast?: string
): ValueExpression<T>;
...
function swt<T extends ExpressionTypes>(
    cases: readonly ({ when: Expression<boolean>; then: Expression<T> } | undefined)[] | undefined,
...
function listOp(
    v1: Expression<number>,
    op: ListOperator,
    v2: readonly Expression<number>[] | undefined
): ValueExpression<boolean>;
function listOp(
    v1: Expression<bigint>,
    op: ListOperator,
    v2: readonly Expression<bigint>[] | undefined
): ValueExpression<boolean>;
function listOp(
    v1: Expression<Decimal>,
    op: ListOperator,
    v2: readonly Expression<Decimal>[] | undefined
): ValueExpression<boolean>;
function listOp(
    v1: Expression<string>,
    op: ListOperator,
    v2: readonly Expression<string>[] | undefined
): ValueExpression<boolean>;
function listOp(
    v1: Expression<Date>,
    op: ListOperator,
    v2: readonly Expression<Date>[] | undefined
): ValueExpression<boolean>;
...
const stringify = <T extends ExpressionTypes>(
    v: T,
