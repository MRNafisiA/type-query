...
test('reference-key and no-on-update and no-on-delete', () => {
    ...
    })).toBe(`CREATE TABLE "public"."test_table"( "id" smallint NULL REFERENCES "public"."ref_table"( "pid" ) ON UPDATE NO ACTION ON DELETE NO ACTION ) ;`);
});
...
test('reference-title and on-update and on-delete', () => {
    ...
    })).toBe(`CREATE TABLE "public"."test_table"( "id" smallint NULL REFERENCES "public"."ref_table"( "custom_title" ) ON UPDATE SET DEFAULT ON DELETE CASCADE ) ;`);
});
...
test('primary', () => {
    ...
    })).toBe(`CREATE TABLE "public"."test_table"( "id" smallint NOT NULL, CONSTRAINT "test_table_pk" PRIMARY KEY( "id" ) ) ;`);
});